<template>
  <div class="min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 bg-background-primary">
...
<style scoped>
/* Garantir que a página ocupe toda a altura da viewport */
html, body {
  height: 100%;
}
</style>